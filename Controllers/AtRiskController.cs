...
namespace UM_Project.Controllers
{
    ...
    public class AtRiskController : Controller
    {
        ...
        public AtRiskController(ApplicationDbContext context, IAtRiskService atRisk, UserManager<ApplicationUser> userManager, IAdminAuditService audit)
        {
            _context = context;
            _atRisk = atRisk;
        ...
        public async Task<IActionResult> AddNote(int studentId, string note)
        {
            ...
            TempData["Success"] = "Intervention note saved.";
            return RedirectToAction(nameof(Index));
        }
    }
}
